...
class UsuarioServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addUsuario = channel.unary_unary(
                ...
                request_serializer=proto_dot_usuario__pb2.UsuarioDTO.SerializeToString,
                response_deserializer=proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
                )
        self.getUsuario = channel.unary_unary(
                '/UsuarioService/getUsuario',
                request_serializer=proto_dot_usuario__pb2.GetUsuarioRequest.SerializeToString,
                response_deserializer=proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
                )
        self.getByUsuarioYClaveRequest = channel.unary_unary(
                '/UsuarioService/getByUsuarioYClaveRequest',
                request_serializer=proto_dot_usuario__pb2.GetByUsuarioYClaveRequest.SerializeToString,
                response_deserializer=proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
                )
...
def add_UsuarioServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'addUsuario': grpc.unary_unary_rpc_method_handler(
                    servicer.addUsuario,
                    request_deserializer=proto_dot_usuario__pb2.UsuarioDTO.FromString,
                    response_serializer=proto_dot_usuario__pb2.UsuarioObjDTO.SerializeToString,
            ),
            'getUsuario': grpc.unary_unary_rpc_method_handler(
                    servicer.getUsuario,
                    request_deserializer=proto_dot_usuario__pb2.GetUsuarioRequest.FromString,
                    response_serializer=proto_dot_usuario__pb2.UsuarioObjDTO.SerializeToString,
            ),
            'getByUsuarioYClaveRequest': grpc.unary_unary_rpc_method_handler(
                    servicer.getByUsuarioYClaveRequest,
                    request_deserializer=proto_dot_usuario__pb2.GetByUsuarioYClaveRequest.FromString,
                    response_serializer=proto_dot_usuario__pb2.UsuarioObjDTO.SerializeToString,
            ),
    }
...
class UsuarioService(object):
    ...
    def addUsuario(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UsuarioService/addUsuario',
            proto_dot_usuario__pb2.UsuarioDTO.SerializeToString,
            proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
    ...
    def getUsuario(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UsuarioService/getUsuario',
            proto_dot_usuario__pb2.GetUsuarioRequest.SerializeToString,
            proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def getByUsuarioYClaveRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UsuarioService/getByUsuarioYClaveRequest',
            proto_dot_usuario__pb2.GetByUsuarioYClaveRequest.SerializeToString,
            proto_dot_usuario__pb2.UsuarioObjDTO.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
